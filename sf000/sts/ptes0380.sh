...
# Objetivo...........: Trunca la particion semanal de la tabla ttes0460.      #
# Nombre del programa: ptes0380.sh                                            #
# Nombre del JOB.....: PTES0380                                               #
# Solicitado por.....:                                                        #
# Descripcion........:                                                        #
# Creacion...........: 09/06/2006                                             #
# Modificacion.......: 26/01/2010                                             #
###############################################################################
set -x
...
then
        if [ -r ${SQLGEN} ]
        then
                sqlplus ${USUARIO} @${SQLGEN} ${LSTSQLGEN} ${FECHA}
                if [ $? != 0 ]
                then
