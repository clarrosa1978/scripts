...
# Objetivo...........: Carga interfases de cheques.                           #
# Nombre del programa: ptes0230.sh                                            #
# Nombre del JOB.....: PTES0230                                               #
# Descripcion........:                                                        #
# Modificacion.......: 14/11/2006                                             #
###############################################################################
...
export EMPRESA=${2}
export SUCURSAL=${3}
export NOMBRE="ptes0230"
export USUARIO="/"
export PATHAPL="/tecnol/sts"
export PATHSQL="${PATHAPL}/sql"
export PATHLOG="${PATHAPL}/log"
export ARCHIVO=`ls -rt /sts/CHEQUES.${SUCURSAL}.????????_??????.DAT |head -1`
...
then
        if [ -r ${SQLGEN} ]
        then
                sqlplus ${USUARIO} @${SQLGEN} ${EMPRESA} ${SUCURSAL} ${ARCHIVO} ${LSTSQLGEN}
                if [ $? != 0 ]
                then
