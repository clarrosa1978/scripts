...
# Objetivo...........: Replicacion turnos                                     #
# Solicitado por.....: Bianculli Jorge                                        #
# Nombre del programa: centralizacionturnos.sh                                #
# Nombre del JOB.....: REPLI-TURNOS                                           #
# Descripcion........:                                                        #
# Creacion...........: 30/08/2013                                             #
...
export FECHA=${1}
export NOMBRE="centralizacionturnos"
export USUARIO="/"
export PATHAPL="/tecnol/turnos"
