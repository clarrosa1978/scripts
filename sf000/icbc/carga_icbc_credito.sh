#!/usr/bin/ksh
###############################################################################
# Nombre del JOB.....: CICBCCRED                                              #
# Aplicacion.........: TARJETAS                                               #
# Grupo..............: ICBC  						      #
# Autor..............: Cristian Larrosa                                       #
# Objetivo...........: Carga archivo COTO_PAYROLL_VISA_CREDITO                #
# Nombre del programa: carga_icbc_credito.sh                                  #
...
###############################################################################
export FECHA=${1}
export NOMBRE="carga_icbc_credito"
export PATHAPL="/tecnol/icbc"
export PATHSQL="${PATHAPL}/sql"
export PATHLOG="${PATHAPL}/log"
export PATHARCH="/icbc"
export ARCHDATA="${PATHARCH}/COTO_PAYROLL_VISA_CREDITO${FECHA}.txt"
