#!/usr/bin/ksh
###############################################################################
# Nombre del JOB.....: CICBCDEB                                               #
# Aplicacion.........: TARJETAS                                               #
# Grupo..............: ICBC  						      #
# Autor..............: Cristian Larrosa                                       #
# Objetivo...........: Carga archivo COTO_PAYROLL_VISA_DEBITO                 #
# Nombre del programa: carga_icbc_debito.sh                                   #
...
###############################################################################
export FECHA=${1}
export NOMBRE="carga_icbc_debito"
export PATHAPL="/tecnol/icbc"
export PATHSQL="${PATHAPL}/sql"
export PATHLOG="${PATHAPL}/log"
export PATHARCH="/icbc"
export ARCHDATA="${PATHARCH}/COTO_PAYROLL_VISA_DEBITO${FECHA}.txt"
