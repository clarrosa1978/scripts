...
# Objetivo...........: Borra registro anteriores tabla GENCF"."T6931000       # 
# Nombre del programa: delete_santander_jubilados.sh                          #
# Nombre del JOB.....: DELSANTJUBILADOS                                       #
...
###############################################################################
export FECHA=${1}
export NOMBRE="delete_santander_jubilados"
