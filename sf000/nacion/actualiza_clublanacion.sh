#!/usr/bin/ksh
###############################################################################
# Nombre del JOB.....: ACTNACION                                              #
# Aplicacion.........: TARJETAS                                               #
# Grupo..............: NACION                                                 #
# Autor..............: Cristian Larrosa                                       #
# Objetivo...........: Inserta las alta y borra las bajas de la tabla de      #
#		       lista blanca.					      #
# Nombre del programa: actualiza_clublanacion.sh                              #
...
###############################################################################
export FECHA=${1}
export NOMBRE="actualiza_clublanacion"
