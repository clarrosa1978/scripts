#!/usr/bin/ksh
###############################################################################
# Nombre del JOB.....: CCLARIN365                                             #
# Aplicacion.........: TARJETAS                                               #
# Grupo..............: CLARIN                                                 #
# Autor..............: Cristian Larrosa                                       #
# Objetivo...........: Carga archivo zonae-FECHA.txt                          #
# Nombre del programa: carga_clarin365.sh                                     #
...
###############################################################################
export FECHA=${1}
export NOMBRE="carga_clarin365"
export PATHAPL="/tecnol/clarin"
export PATHSQL="${PATHAPL}/sql"
export PATHLOG="${PATHAPL}/log"
export PATHARCH="/clarin"
export ARCHDATA="${PATHARCH}/zonae-${FECHA}.txt"
