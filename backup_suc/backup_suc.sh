...
genera_tar ()
{
	...
	do
		...
		then
			...
			if [ ${FS_TAR} = 'home' ]
			then
				tar cvjf $FS_PRO/$ARCH_TAR --ignore-failed-read --exclude="/home/sfftp" --exclude="/home/root" --exclude="/home/rfctrl" --exclude="/home/java" --exclude="/home/ctmagt" --exclude="/home/ctmsrv7" --exclude="/home/ctm"  /$FS_TAR  1>/dev/null
			CMD_TAR_STAT="`echo $?`"
			else
