...
case $HOST in
        "amscentral") #Definicion de variables
			...
			export SUB_DIR="suc"
                        export FILES_TO_CHCK="tc03020I tc03020F zeta "
                ;;
	...
	"sp17")	#Definicion de variables
		...
		;;
	"S80-FNCL") #Definicion de variables
			export PATH_ARCHIVOS="/u08/desacoto/interface/recepcion"
			export SUB_DIR=""
			export FILES_TO_CHCK="vta"
		;;
esac
