...
# Objetivo...........: Mata las conexiones a la base de datos del usuario     #
#                      pasado como parametro.                                 #
# Nombre del programa: killses.sh                                             #
# Nombre del JOB.....: KILLSES                                                #
# Descripcion........:                                                        #
...
then
        if [ -r ${SQLGEN} ]
        then
                sqlplus ${USUARIO} @${SQLGEN} ${LSTSQLGEN} ${KILLUSU}
                if [ $? != 0 ]
                then
