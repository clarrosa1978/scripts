...
# Objetivo...........: Da de baja en GPA los articulos que se den de baja     #
# Nombre del programa: granjaBajaArticulos.sh                                 # 
# Nombre del JOB.....: GRANJABAJAART                                          #   
...
###############################################################################
export FECHA=${1} 
export NOMBRE="granjaBajaArticulos"
