...
# Objetivo...........: Carga los nacimientos de los pollitos nacidos para     #
# Nombre del programa: pizarranacimiento.sh                                   # 
# Nombre del JOB.....: PIZARRANACIMIENTO                                      #   
# Modificacion.......: 03/06/2021                                             #
###############################################################################
...
###############################################################################
export FECHA=${1} 
export NOMBRE="pizarranacimiento"
