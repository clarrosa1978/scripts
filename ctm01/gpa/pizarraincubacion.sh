...
# Objetivo...........: Genera informacion para Pizzarron de Incubacion        #
# Nombre del programa: pizarraincubacion.sh                                   # 
# Nombre del JOB.....: PIZARRAINCUBACION                                      #   
...
###############################################################################
export FECHA=${1} 
export NOMBRE="pizarraincubacion"
