...
export LOGSCRIPT="${PATHLOG}/${NOMBRE}.${ORACLE_SID}.${SNAPSHOT}.${FECHA}.log"
export USUARIO="/@PT01GPA"
export SQLGEN="${PATHSQL}/${NOMBRE}.sql"
export LSTSQLGEN="${PATHLOG}/${NOMBRE}.${ORACLE_SID}.${SNAPSHOT}.${FECHA}.lst"
                ...
                then
                        ...
                        then
                                ...
                                then
                                        ...
                                        find ${PATHLOG} -name "${NOMBRE}*.${SNAPSHOTS}*.lst" -mtime +7 -exec rm {} \;
                                        find ${PATHLOG} -name "${NOMBRE}*.${SNAPSHOTS}*.log" -mtime +7 -exec rm {} \;
                                        exit 0
                                else
