...
then
	...
	do
		#sudo /tecnol/util/safe_scp.sh P ${PATHBKP} ${iso} ${SERVDESTINO} /mksysb ${iso}.${SERVIDOR} root system 750
		/tecnol/util/safe_scp.sh P ${PATHBKP} ${iso} ${SERVDESTINO} /mksysb ${iso}.${SERVIDOR} transfer system 750
		EXIT=$?
		case ${EXIT} in
