...
export OPERACION=${1}
export SERVICIO="nagios"								# <--- Nombre del servicio a controlar
...
export SERVICIO="nagios"								# <--- Usuario del servicios a Controlar
export USUARIO="nagios"

#--------------     Servicios a controlar ( que buscar en el OS ) ------------#
export LISTASERV="nrpe.cfg"                        			 # <--- Ingresar los servicios que se desean controlar
...
/opt/nagios/bin/rc.nagios start
