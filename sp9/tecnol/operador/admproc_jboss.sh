...
export PATHAPL="${PATHPRC}/server/cotocd"   					# <--- Directorio del proceso a controlar
...
cd ~${USUARIO}
su - jboss -c "nohup /jboss/bin/run.sh -c cotocd -b jas4.redcoto.com.ar &" 1>/dev/null		# <--- Forma de subir el proceso
