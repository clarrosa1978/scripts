#set -x                                                                         
echo "Antes de ejecutar este script asegurarse que en el servidor gdmc no tenga procesos activos."
...
echo "Eliminando Alias para GDM en placa en0"                               
chdev -l en0 -a delalias4='172.16.7.13,255.255.255.0'                          
